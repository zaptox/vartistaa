...
public class MyCompletedServices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_completed_services);
        ...
        new MyCompletedServices.Conncetion(MyCompletedServices.this,user_id1).execute();
    }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    listadapter = new ServiceUserAppointmentsAdapter(getApplicationContext(),userAppointments,true);
